<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Register.aspx.cs" Inherits="project_class.Register" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
 <div align="center">
    <style>
        h1{font-weight:bold; font-family:Calibri Light; font-size:45px;color:black}
        h2{font-weight:bold; font-family:Calibri Light; font-size:30px;color:black}
        body{background-image:url("pics/background.jpg.png");
				background-repeat:no-repeat;
				background-attachment:fixed;
				background-size:100% 100%;}
        h3{font-family:Calibri Light;}
        table{font-family:Calibri Light; direction:rtl; text-align:center; font-size:20px; border:2px solid black; margin:0px auto;color:white}
       td{text-align:center; font-family:Calibri Light; font-size: 20px;color:white}
       footer {
				position:absolute;
				left:55px;
	   }
        ...
        <table >
            <tr>
                ...
                <td><input type="text" id="mUName" size="30"
                    style="display:none; font-weight:bold;" disabled="disabled" />
                </td>
            </tr>
            ...
            <td> מספר טלפון :</td>
                ...
                <td dir="ltr">
                    <select style="color:black" name="prefix" id="prefix">
            ...
            <tr>
             ...
             <tr>
                ...
                <td><input type="text" id="mhobbies" size="30"
                    style="display:none; font-weight:bold;" disabled="disabled" />
                 </td>
            </tr>
            <tr>
                <td colspan="2" style="text-align:center;">
                    <input style="color:black" type="submit" name="submit" value="     שלח         " />
                </td>
            </tr>
